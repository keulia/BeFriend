                    ...
                    .document(idDoc).set(
                        mapOf(
                            ...
                            "conversaciones" to mutableListOf<String>(
                                "Habla de la última película que has visto.",
                                ...
                                "Pregunta que ha hecho últimamente.",
                                ...
                                "Pregunta que tal le va la vida.",
                                "Si ha subido algo a una red social, comenta.",
                                "Cuenta un chiste.",
                                "Menciona una historia del pasado.",
                                "Pregunta como se siente.",
                                "Pregunta como se ha sentido últimamente.",
                                "simplemente saluda :)"
                            )
                        )
